...
import { Calendar, Clock, Target, CheckCircle, ChevronLeft, ChevronRight } from "lucide-react"
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={loading || !formData.timeframe || !formData.goal}>
                {loading ? "Generating Schedule..." : "Create My Schedule"}
              </Button>
            </form>
          </CardContent>
        </Card>
          ...
          <CardContent>
            {!schedule && !loading && (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>Fill out the form to generate your personalized schedule</p>
              </div>
            )}
            {loading && (
